...
<content class="flexBoxContainer">
    <div class="backgroundPanel homePageFlexBox">
        ...
        <a href="about.php" class="bpButton">More Information</a>
    </div>
    ...
    <div class="backgroundPanel homePageFlexBox">
        ...
        <p>If you're curious about the world of Clean Burning Black Rocks Inc., be sure to check out our investors page. Here you can find various articles from across the world of Clean Burning Black Rocks from major scientific discoveries to our success in world politics! Of course, you can also see the amazing people that have decided, "Yes, I believe in Clean Burning Black Rocks and can tell that Clean Burning Black Rocks Inc. can lead us to a better future!" To check all this out, just click the link below!</p>
        <a href="investors.php" class="bpButton">More Information</a>
    </div>
